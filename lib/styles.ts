...
export const cardVariants = {
  default: 'bg-background-card rounded-2xl border border-border-primary shadow-lg',
  glass: 'bg-background-glass backdrop-blur-lg border border-white/10 rounded-2xl shadow-xl',
  elevated: 'bg-background-card rounded-2xl border border-border-primary shadow-2xl',
} as const;
