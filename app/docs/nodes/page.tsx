...
const nodeCategories = [
  ...
  },
  {
    ...
    nodes: [
      ...
      { name: "Notion Database Query", href: "/docs/nodes/notion-database-query", description: "Query entries from Notion databases", icon: Database, color: "text-gray-500" },
      { name: "Notion Page Create", href: "/docs/nodes/notion-page-create", description: "Create new pages in Notion databases", icon: Plus, color: "text-gray-500" },
      { name: "Notion Page Update", href: "/docs/nodes/notion-page-update", description: "Update properties of existing Notion pages", icon: FileText, color: "text-gray-500" },
