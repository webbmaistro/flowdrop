...
export default function OutlookSendEmailNode() {
  const prerequisites = [
    {
      icon: Shield,
  ...
  return (
    <NodeLayout>
      ...
      <OverviewSection
        description="The <strong>Outlook Send Email</strong> node is an action node that sends emails using your connected Microsoft Outlook account. This powerful integration enables you to programmatically send emails through Microsoft Graph API, perfect for automated notifications, workflow-based communications, and business process automation."
        keyFeatures={[
          ...
          "<strong>Microsoft Integration:</strong> Seamless integration with Microsoft Outlook and Exchange",
              ...
              <div className="space-y-4">
                <div className="bg-neutral-800 rounded-lg p-4">
                  ...
                  <div className="text-sm text-neutral-400 space-y-1">
                    <div>🔔 Webhook Trigger → 📊 Process Data → 📧 Outlook Send Email → ✅ Confirm</div>
                  </div>
                </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="bg-neutral-800 rounded-lg p-4">
                  <h4 className="font-semibold mb-2">Workflow Structure</h4>
                  <div className="text-sm text-neutral-400 space-y-1">
                    <div>📊 Data Source → 🤖 AI Content Generation → 📧 Outlook Send Email → 📈 Analytics</div>
                  </div>
                </div>
                <p className="text-neutral-400 text-sm">
  ...
  <div class="email-container">
    ...
    <div class="content">
      ...
      <BestPracticesSection
        ...
        proTip="For best results, test your HTML email templates across different email clients (Outlook, Gmail, Apple Mail) to ensure consistent rendering. Use inline CSS styles for better compatibility."
      />
